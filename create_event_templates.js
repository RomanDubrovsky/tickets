...
const flatsomePath = path.join(__dirname, 'b2b_cms', 'templates', 'flatsome.html');
...
const flatsomeEventPath = path.join(__dirname, 'b2b_cms', 'templates', 'flatsome_event.html');
...
const basePath = path.join(__dirname, 'b2b_cms', 'templates', 'base.html');
...
const baseEventPath = path.join(__dirname, 'b2b_cms', 'templates', 'base_event.html');
